...
gen-examples:
	cp src/data/examples/valid/ThingCollection*.yaml $(EXAMPLEDIR)
...
examples/output: src/identifiers_sandbox/schema/identifiers_sandbox.yaml
	mkdir -p $@
...
git-init:
	git init
git-add: .cruft.json
	git add .gitignore .github .cruft.json Makefile LICENSE *.md examples utils about.yaml mkdocs.yml poetry.lock project.Makefile pyproject.toml src/identifiers_sandbox/schema/*yaml src/*/datamodel/*py src/data src/docs tests src/*/_version.py project/reports/ src/local_schemasheets/
